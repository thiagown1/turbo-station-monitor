...
test('recognizes common natural station-name phrasings', async (t) => {
  const scenarios = [
    ...
    ['O Habibs se comunicou?', 'Habibs'],
    ['O Habibs não se comunicou?', 'Habibs'],
    ['A estação do Habibs caiu?', 'Habibs'],
    ['A estação de recarga do Habibs caiu?', 'Habibs'],
    ['Caiu a estação de recarga do Habibs?', 'Habibs'],
    ...
    ['Queria saber se o Habibs caiu?', 'Habibs'],
    ['Voltou ao normal o Habibs?', 'Habibs'],
    ['Voltou ao ar o Habibs?', 'Habibs'],
...
test('strips past-time tails after state-first station names', async (t) => {
  const scenarios = [
    ...
    'Caiu o Habibs há pouco?',
    'Voltou o Habibs faz pouco?',
  ];
...
test('does not invent a station name when the natural question omits the venue', async (t) => {
  const scenarios = [
    ...
    'Alguém sabe se caiu?',
    'Alguém sabe se voltou?',
    'Queria saber se caiu?',
    'Eu queria saber se caiu?',
    'Gostaria de saber se caiu?',
    'Eu gostaria de saber se caiu?',
    'Voltou ao normal?',
    'Voltou ao ar?',
    'Caiu por causa da chuva?',
    'Caiu por conta do temporal?',
    'Caiu por falta de energia?',
    'Caiu por motivo de manutenção?',
    'Caiu porque choveu?',
    'Caiu devido à chuva?',
    'Caiu durante a noite?',
    'Caiu após a manutenção?',
    'Caiu às 10h?',
    'Caiu as 10:30?',
    'Caiu 10h?',
    'Caiu há 2 horas?',
    'Caiu faz duas horas?',
    'Caiu há uns 10 minutos?',
    'Caiu faz cerca de três dias?',
    'Caiu há pouco?',
    'Voltou faz pouco?',
    'Como ficou depois da queda?',
    'Como ficou antes da manutenção?',
    'Caiu desde ontem?',
    'Está offline?',
    'Está online?',
    'Ficou sem energia?',
