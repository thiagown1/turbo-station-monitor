...
partner_payment_receipt e expense_receipt são os dois lados do mesmo PIX e só se distinguem pelo favorecido: use partner_payment_receipt somente quando o dinheiro foi para um PARCEIRO dono de estação (repasse da receita dele), e expense_receipt quando foi para um fornecedor da Turbo Station — concessionária de energia (Equatorial, Neoenergia, Enel, CEB, CPFL), gateway de pagamento, provedor de nuvem/IA, contador, aluguel, imposto. Um PIX para concessionária de energia é expense_receipt, nunca repasse.
